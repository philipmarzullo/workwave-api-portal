  ...
  function handleSubmit() {
    ...
    try {
      const newRequest = store.createRequest({
        ...
        databases: databases.filter(db => db.databaseName.trim()),
      })
          ...
          <div className="flex items-start gap-2.5 mb-4 bg-blue-50 border border-blue-200 rounded-lg px-4 py-3">
            ...
            <div className="text-xs text-blue-800 leading-relaxed">
              ...
              <p className="text-blue-600">
                You can find your database identifier in your product's admin settings or system defaults.
              </p>
            </div>
          </div>
