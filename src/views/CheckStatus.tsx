    ...
    <div className="max-w-[640px] mx-auto py-10">
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-sm font-medium transition-all shrink-0 ${
            agentOpen
      ...
      {/* Ask the Agent panel */}
      {agentOpen && (
        <div className="rounded-lg border border-ww-primary/30 bg-white overflow-hidden flex flex-col mb-8" style={{ maxHeight: '480px' }}>
            ...
            {agentMessages.length === 0 && !agentLoading ? (
              <div className="p-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {[
                    'What do the different review stages mean?',
                    'Why might my request be on hold?',
                    'How long does each review stage typically take?',
                    'What happens after sandbox approval?',
                  ].map(q => (
                    <button
                      key={q}
                      onClick={() => {
          ...
          <div className="border-t border-ww-gray-100 px-3 py-2 shrink-0">
            <div className="flex gap-2">
              <textarea
                ...
                placeholder={agentMessages.length > 0 ? 'Ask a follow-up...' : 'Ask about request status, review process...'}
                rows={1}
